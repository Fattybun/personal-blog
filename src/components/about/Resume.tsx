...
const DownloadCVButton = () => (
  <Button className="w-fit text-xs md:text-base">
    <Link target="_blank" href="/assets/resume.pdf" rel="noopener noreferrer">
      Download CV
    </Link>
  </Button>
);
...
const Header = () => (
  <header className="text-center mt-8">
    <h1 className="font-extrabold text-xl md:text-3xl text-gray-800">
      Jacky Lau Chong Bao
    </h1>
    <div className="text-lg md:text-xl text-gray-600">Frontend Engineer</div>
    <div className="text-md md:text-md text-gray-600 mb-6">
      ...
      >
        ...
        <Section title="Summary">
          <p className="text-justify text-gray-600">
            ...
            user-centric interfaces, and collaborating effectively on team
        ...
        <Section title="Experiences">
          {experience.map(
            ({ date, title, company, location, tasks }, index) => (
              <article key={index} className="w-full mb-2">
